...
**StructVis** — це інтерактивний візуалізатор структур даних, створений для допомоги у розумінні того, як фундаментальні структури даних (зв'язні списки, графи, дерева тощо) та алгоритми працюють "під капотом". 
